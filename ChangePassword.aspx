<%@ page language="C#" autoeventwireup="true" inherits="User_ChangePassword, App_Web_jdmtmhii" %>
...
<body>
    <form id="form1" runat="server">
     <div align="center"        
         ...
         style="background-image:url('../images/j.jpg'); background-repeat:no-repeat; background-position:100% top; height:151px; width:100%; margin-top: 0px;">
  ...
  <a href="Dashboard.aspx" id="HOME">HOME</a>
  <a href="Raiserequest.aspx" id="REQUEST_DETAILS">REQUEST DETAILS</a>
  <a href="ChangePassword.aspx" id="CHANGE_PASSWORD">CHANGE PASSWORD</a>
   <a href="../others/login.aspx" id="logout">LOGOUT</a>
        ...
        <td style="background-image: url('../images/m.jpf.jpg'); background-repeat:no-repeat; background-position:center; " 
                class="style4"></td></tr>
        </table>
    </div>
    </form>
